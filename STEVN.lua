...
./tg -s ./STEVN.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("Run", "w")  
...
⌁︙[Exp Source](https://t.me/STEVNBOT6)

⌁︙[Developer](https://t.me/OR_33)
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
⌁︙[Tws DevProx](https://t.me/IRAQLOR_bot)
]]
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './STEVN.lua', '⌁︙نسخة ملف سورس بروكس',dl_cb, nil)
end end
--     Source DevProx     --
...
os.execute('rm -rf STEVN.lua') 
os.execute('wget https://raw.githubusercontent.com/STEVNMN/STEVNMNR/master/STEVN.lua') 
dofile('STEVN.lua') 
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/STEVNMN/STEVNMNRFiles/master/STEVNMNRFiles/"..FileName)
if Res == 200 then
